...
//Створити клас Product(назва,ціна,тип(для цього можете створити енум)і ще 1-3поля за власним бажанням).
...
public class Main {
    public static void main(String[] args) {
        ...
        myStore.fillStore();
        myStore.increasePrice(Type.CAKES);
        myStore.removeProduct("Vodka");
        myStore.avgPrice();
        myStore.totalPriceOfCurrentType(Type.DRINKS);
        myStore.getProductsOverPrice(300);
        myStore.addProduct(new Product("Whiskey12 Black Jack", 600, Type.DRINKS, Category.THIRD));
        myStore.getAllProducts();
    }
}
